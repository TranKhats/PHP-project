...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2018 at 04:46 PM
...
INSERT INTO `permision` (`id_func`, `id_user`, `id_permision`) VALUES
(1, 10, 1);
...
--
-- Error reading structure for table muabansuachualaptop.taikhoan: #1146 - Table 'muabansuachualaptop.taikhoan' doesn't exist
-- Error reading data for table muabansuachualaptop.taikhoan: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `muabansuachualaptop`.`taikhoan`' at line 1
...
INSERT INTO `user` (`password`, `full_name`, `date_created`, `user_name`, `id_user`) VALUES
('1', '2', '0000-00-00', NULL, 1),
('202cb962ac59075b964b07152d234b70', 'fsfssfs', NULL, 'thoibay74@outlook.com.vn', 9),
('21232f297a57a5a743894a0e4a801fc3', 'accountadmin', NULL, 'kharomts95@gmail.com.vn', 10),
('202cb962ac59075b964b07152d234b70', 'thuancao', NULL, 'ca1o@gmail.com', 18),
('202cb962ac59075b964b07152d234b70', 'thuancao', NULL, 'thuan@gmail.com', 19);
...
--
ALTER TABLE `permision`
  MODIFY `id_permision` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `permision`
  ADD CONSTRAINT `fk_PERMISION_user1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION;
